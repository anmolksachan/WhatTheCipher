...
def banner():
  ...
  █  █  █ █   █ █  █   █            █    █   █ █▄   ▄▀     █▄  ▄▀ ▐█ █     █   █ █▄   ▄▀ █  █  
   █ █ █     █     █  ▀            ▀        █  ▀███▀       ▀███▀   ▐  █       █  ▀███▀     █   
    ▀ ▀     ▀     █                        ▀                           ▀     ▀            ▀    
                 ▀         {Fore.RESET}                                                                     
  {Fore.GREEN}What The Cipher Variant (WTC_v1 - Scans multiple host with multiple reports) by @FR13ND0x7F {Fore.RESET}
  """) 

def load_animation():
        print(f"{Fore.GREEN}What The Cipher Variant (WTC_v1 - Scans multiple host with multiple reports) by @FR13ND0x7F {Fore.RESET}")
...
def main():
   ...
   banner()
   while True:
        domain = input("\nEnter domain name / IP (press q to quit): ")
        if domain.lower() == "q":
            break
